  ...
  <div style="width: 100%;height: 100%;position: relative;">
    ...
    <div style="position: absolute;left: 40px;bottom: 40px;z-index: 99999;">
      ...
      <el-popover placement="bottom" title="标题" width="200" trigger="click" content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。">
        <el-button slot="reference">BBB</el-button>
      </el-popover>
...
export default {
  ...
  data() {
    return {
      fsfsList: [{ key: '隧道', value: 'a', color: 'red' }, { key: '电缆沟', value: 'b', color: 'green' }, { key: '排管', value: 'c', color: 'blue' }, //敷设方式
      { key: '拖拉管', value: 'd', color: 'red' }, { key: '顶管', value: 'e', color: 'green' }, { key: '综合管廊', value: 'f', color: 'blue' }
      ],
      fsfsChecked: [],
