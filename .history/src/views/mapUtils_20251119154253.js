...
function addChannelEquipment(data) {
  const iconMap = {
    '1': require("@/assets/img/1.png").default,
    '2': require("@/assets/img/2.png").default,
    '3': require("@/assets/img/3.png").default,
    '4': require("@/assets/img/4.png").default,
    '5': require("@/assets/img/5.png").default,
    '6': require("@/assets/img/6.png").default,
    '7': require("@/assets/img/7.png").default,
    '8': require("@/assets/img/8.png").default,
  };
