...
// 添加通道设备
function addChannelEquipment() {
  // 1. 定义 sblx 与图片的对应关系
  const imageMap = {
    转弯井: require("@/assets/img/1.png"),
    直通井: require("@/assets/img/2.png"),
    转角井: require("@/assets/img/3.png"),
    接头井: require("@/assets/img/4.png"),
    三通井: require("@/assets/img/5png"),
    四通井: require("@/assets/img/6.png"),
    余缆井: require("@/assets/img/7.png"),
    直线井: require("@/assets/img/8.png")
  };
